...
* TODO BB integrations / failure details [15/22]
...
- [X] fix date formatting and/or file ticket about inconsistent formats
- [X] readable buffer names
  - [X] brief title in log view
  - [X] truncate patch description
- [X] time taken for tests
- [ ] files
  - [ ] proper buffer name
  - [ ] evg-find-file to interactively download/open file
  - [ ] message file url on hover
  - [ ] back from file with "q"
- [ ] sort failed build variants to the top
- [ ] "relevant commits"
